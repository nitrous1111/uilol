...
-- Menu/UI Creation
if not isfile("Nitrous") then
    makefolder("Nitrous")
 end
 
 local menu = game:GetObjects("rbxassetid://17429679584")[1] 
 local tabholder = menu.BG.main.group;
 local tabviewer = menu.BG.BA.tabbuttons;
 for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('userlabel') then
        obj.Text = 'active user: <font color="rgb(202, 82, 147)">' .. game.Players.LocalPlayer.Name .. '</font>'
    end
    if obj.Name:lower():find('buildlabel') then
        obj.Text = 'build: <font color="rgb(202, 82, 147)">Public</font>'
    end
 end
 ...
 KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(202, 82, 147)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
 ...
 Name.Text = "[<font color=\"rgb(202, 82, 147)\">Keybinds</font>]"
 ...
 Name_2.Text = "Silent Aim: <font color=\"rgb(202, 82, 147)\">[MB1]</font>"
 ...
 local function createWatermark()
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(202, 82, 147)
    ...
    task.spawn(function()
       while task.wait() do
         ...
         WaterMarkLabel.Text = 'Nitrous<font color="rgb(74, 74, 74)"></font> - uid: <font color="rgb(74, 74, 74)">' .. uid .. '</font> / fps: <font color="rgb(202, 82, 147)">' .. fpsValue .. '</font> / ping: <font color="rgb(202, 82, 147)">' .. ping .. '</font> / time: <font color="rgb(202, 82, 147)">' .. time .. '</font>'
       end
    end)
    return Watermark
 end
 ...
 local library = {
    Title = 'Nitrous<font color="rgb(74, 74, 74)"></font> | Private',
    keybind = Enum.KeyCode.RightBracket,
    Watermark = createWatermark(),
       Colors = {
          libColor = Color3.fromRGB(202, 82, 147),
          riskyColor = Color3.fromRGB(255, 0, 0),
          FontColor = Color3.fromRGB(255, 255, 255),
          MainColor = Color3.fromRGB(14, 14, 14),
          AccentColor = Color3.fromRGB(202, 82, 147),
    ...
    CloneScreenGui.Name = "Nitrous_gui"


    local close = Instance.new("TextLabel")

    close.Name = "close"
    close.Parent = menu.BG.top
    close.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    close.BackgroundTransparency = 1.000
    close.BorderColor3 = Color3.fromRGB(0, 0, 0)
    close.BorderSizePixel = 0
    close.Position = UDim2.new(0.00700002024, 0, 0.24242425, 0)
    close.Size = UDim2.new(0, 149, 0, 25)
    close.Font = Enum.Font.SourceSans
    close.Text = "Nitrous Trident Survival"
    close.TextColor3 = Color3.fromRGB(202, 82, 147)
    close.TextSize = 17.000
    close.TextXAlignment = Enum.TextXAlignment.Left

    -- Animation variables
local text = "Nitrous Trident Survival"
local speed = 0.07 -- Typing speed (lower is faster)
local waitTime = 0.7 -- Time to wait before restarting animation
local colors = {
    Color3.fromRGB(202, 82, 147),     -- Text color
}
...
local musicplayer = Instance.new("TextBox")
musicplayer.Name = "musicplayer"
musicplayer.Parent = menu.BG
musicplayer.BackgroundColor3 = Color3.fromRGB(9, 9, 9)
musicplayer.BorderColor3 = Color3.fromRGB(255, 255, 255)
musicplayer.Position = UDim2.new(0.832891226, 0, 0.0167112201, 0)
musicplayer.Size = UDim2.new(0, 122, 0, 18)
musicplayer.Font = Enum.Font.SourceSans
musicplayer.Text = "Put Music Id Here"
musicplayer.TextColor3 = Color3.fromRGB(255, 255, 255)
musicplayer.TextSize = 14.000

local Stopplay = Instance.new("TextButton")
Stopplay.Name = "Stopplay"
Stopplay.Parent = menu.BG
Stopplay.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Stopplay.BorderColor3 = Color3.fromRGB(255, 255, 255)
Stopplay.Position = UDim2.new(0.730000019, 0, 0.0199999996, 0)
Stopplay.Size = UDim2.new(0, 74, 0, 16)
Stopplay.Font = Enum.Font.SourceSans
Stopplay.Text = "Stop/Play"
...
local function toggleMusic()
    if sound then
        ...
        local musicId = tonumber(musicplayer.Text)
        if musicId then
            sound = Instance.new("Sound")
            sound.SoundId = "rbxassetid://" .. musicId
            sound.Parent = game.Workspace -- You may want to parent this to a different service, depending on your use case
            sound:Play()
        else
...
Stopplay.MouseButton1Click:Connect(toggleMusic)
    ...
    for _, obj in pairs(menu:GetDescendants()) do
        if obj.Name:lower():find('name_esp') then
           obj.Text = '<font color="rgb(202, 82, 147)">' .. game.Players.LocalPlayer.Name .. '</font>'
        end
    end
    ...
    library:Create('UIListLayout', {Padding = UDim.new(0, 4); FillDirection = Enum.FillDirection.Vertical; SortOrder = Enum.SortOrder.LayoutOrder; Parent = library.NotificationArea})
        ...
        function library:Notify(Text, Time)
            ...
            local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(202, 82, 147); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
            ...
            draggable(menu.BG)
                ...
                function library:Tween(...) TweenService:Create(...):Play() end
                    function library:addTab(name,image)
                        ...
                        local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(202, 82, 147)})
                        local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(202, 82, 147)})
                        ...
                        function group:addToggle(args)
                            ...
                            function toggle:addKeybind(args)
                                    ...
                                    if key.Name == "Unknown" or key.Name == "Unknown" then
                                        ...
                                        if args.gui then
                                            ...
                                            if args.type == "hold" then
                                                Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(202, 82, 147)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                            else
                                                if not Toggle then
                                                    Toggle = true
                                                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(202, 82, 147)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                    ...
                                                    Toggle = false
                                                    Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(202, 82, 147)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                                end
                                            end
                                        end
                                    end
                                ...
                                if args.gui then
                                    Name.Visible = true
                                    Name.Text = args.text..": <font color=\"rgb(202, 82, 147)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                                end
                        ...
                        for _, v in pairs(list) do
                            ...
                            writefile("Nitrous/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
                ...
                function library:refreshConfigs()
                    local tbl = {}
                    for i,v in next, listfiles("Nitrous") do table.insert(tbl,v) end
